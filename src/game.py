...
class Game:
    ...
    def __init__(self, player1: Player, player2: Optional[Player] = None):
        ...
        self._winner = None
        self._intelligence = Intelligence() if player2 is None else None
...
"""
    ...
    def computer_turn(self, difficulty: str = None) -> List[int]:
        ...
        turn_rolls = []
        max_rolls = self._intelligence.get_max_rolls(difficulty_to_use, self._current_player.current_score, 
                                                   self._player1.current_score)
